...
<div class="container mx-auto px-4 py-8">
    <div class="max-w-3xl mx-auto bg-white rounded-lg shadow-lg p-6">
        <div class="flex justify-between items-center mb-6">
            <h2 class="text-2xl font-bold text-gray-800">Ajouter une Publicité</h2>
        ...
        <form action="{{ route('dashboard.advertisements.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
            @csrf
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div id="upload-section" class="md:col-span-2 {{ old('video_type') && old('video_type') !== 'upload' ? 'hidden' : '' }}">
                ...
                <div id="link-section" class="md:col-span-2 {{ !old('video_type') || old('video_type') === 'upload' ? 'hidden' : '' }}">
                    ...
                    <input type="url" name="video_link" id="video_link" value="{{ old('video_link') }}"
                           ...
                           placeholder="https://...">
                    <p class="mt-1 text-sm text-gray-500">Collez le lien YouTube ou Google Drive de votre vidéo</p>
                </div>
                ...
                <div class="md:col-span-2">
                    <div class="flex items-center">
                        ...
                        <label for="is_active" class="ml-2 block text-sm text-gray-700">
                            Activer la publicité immédiatement
                        </label>
                    </div>
                </div>
            </div>
