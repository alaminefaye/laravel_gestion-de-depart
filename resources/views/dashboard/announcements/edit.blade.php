    ...
    <div class="max-w-3xl mx-auto bg-white rounded-lg shadow-lg p-6">
        ...
        <form action="{{ route('dashboard.announcements.update', $announcement) }}" method="POST" class="space-y-6">
            ...
            <div>
                ...
                <textarea name="content" id="content" rows="4" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500" required>{{ old('content', $announcement->content) }}</textarea>
                @error('content')
